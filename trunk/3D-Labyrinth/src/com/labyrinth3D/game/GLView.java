...
import com.labyrinth3D.AccelerometerListener;
import com.labyrinth3D.AccelerometerManager;
import com.labyrinth3D.math.Vector3;
...
public class GLView extends GLSurfaceView implements GLSurfaceView.Renderer, AccelerometerListener
{
    ...
    public void onDrawFrame(GL10 gl)
    {
        ...
        //camera.z = (camera.z + acceleration.x);


        //Move z units into the screen
        //gl.glTranslatef(0, 0, camera.z);			//Move z units into the screen

        //Rotate around the axis based on the rotation matrix (rotation, x, y, z)
        //gl.glRotatef(camera.x, 1.0f, 0.0f, 0.0f);	//X
        //gl.glRotatef(camera.y, 0.0f, 1.0f, 0.0f);	//Y
        ...
        //System.out.println("Render- time: " + renderTime + " , Cycle time: " + cycleTime);
        //Log.d("INFO", "Render time: " + renderTime);
    }
    ...
    public void destroy()
    {
        ...
        if (AccelerometerManager.isSupported(context))
        {
            System.out.println("CLEANING ACCELEROMETER");
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event)
    {
        ...
        if (keyCode == KeyEvent.KEYCODE_DPAD_CENTER)
        {
            if (AccelerometerManager.isSupported(context))
            {
                ...
                {
                    System.out.println("STOPING ACCELEROMETER");
                    accelerometerManager.stopRunning();
                }
                else
                {
